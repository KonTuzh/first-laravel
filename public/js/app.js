...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_slider_basic__ = __webpack_require__(41);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_slider_popularWeek__ = __webpack_require__(68);
...
var update = __webpack_require__(44)("336c8cf3", content, false, {});
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_slider__ = __webpack_require__(48);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(44)("5da09aba", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils_detect_prefixes_js__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__slider_basic_vue__ = __webpack_require__(41);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__slider_basic_loop_vue__ = __webpack_require__(53);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__slider_fade_vue__ = __webpack_require__(56);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__slider_coverflow_vue__ = __webpack_require__(59);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    transform: function transform(index) {
      var winWidth = this.temporarydata.pageWidth;
      var height = '';
      ...
      var width = this.pages[index].style.width.indexOf('px') === -1 ? this.temporarydata.pageWidth * parseFloat(this.pages[index].style.width) / 100 : parseFloat(this.pages[index].style.width);
      var offsetWidth = winWidth / 2 - width / 2;
      var leftWidth = offsetWidth - this.temporarydata.deviation + 'px';
      var rightWidth = offsetWidth + this.temporarydata.deviation + width * (1 - this.temporarydata.widthScalingRatio) + 'px';
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(44)("44c6b51a", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
